...
void assignDiskMemoryValue(unsigned char *diskMemory)
{
  ...
  outputfileDiskMemory = fopen("/Users/elainechong/Desktop/solution/data/disk_memory.txt", "w");
...
void assignMemoryValue(unsigned char *mainMemory)
{
  ...
  outputfileMaineMemory = fopen("/Users/elainechong/Desktop/solution/data/physical_memory.txt", "w");
  outputfilepPageTable = fopen("/Users/elainechong/Desktop/solution/data/page_table.txt", "w");
